...
def _sanitize(unsanitized_input: Dict[str, Any]) -> Dict[str, Any]:
    ...
    This function wraps the call to opf.sanitize().
    ...
    unsanitized_input : dict
        ...
        opf.sanitize. If the history key is contained in the dictionary then
    ...
    if "history" not in unsanitized_input:
        return opf.sanitize(unsanitized_input)
    ...
    sanitized_response = opf.sanitize(unsanitized_input)
